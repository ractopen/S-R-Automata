                ...
                <table role="presentation" width="100%" max-width="600" style="max-width: 600px; width: 100%; background-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <h2 style="font-size: 20px; font-weight: 700; color: #0f172a; margin-top: 0; margin-bottom: 20px; text-align: center;">Login Verification</h2>
                            
                            <p style="font-size: 16px; color: #334155; margin-bottom: 24px; text-align: center;">Hello,</p>
                            <p style="font-size: 16px; color: #334155; margin-bottom: 24px; text-align: center;">Please use the following One-Time Password (OTP) to authorize your login:</p>
                            ...
                            <p style="font-size: 14px; color: #94a3b8; margin-top: 24px; text-align: center; border-top: 1px solid #f1f5f9; padding-top: 20px;">If you did not request this code, you can safely ignore this email.</p>
                        </td>
                    </tr>
                    <!-- Footer -->
                    <tr>
