                    ...
                    <section>
                        ...
                        <form method="POST" action="{{ route('users.store') }}" class="mt-6 space-y-6">
                            ...
                            <div class="block mt-4">
                                <label for="pre_verified" class="inline-flex items-center">
                                    <input id="pre_verified" type="checkbox" name="pre_verified" value="1" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" {{ old('pre_verified') ? 'checked' : '' }}>
                                    <span class="ms-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Pre-verify Email Address (Skip verification on login)') }}</span>
                                </label>
                                <x-input-error class="mt-2" :messages="$errors->get('pre_verified')" />
                            </div>
